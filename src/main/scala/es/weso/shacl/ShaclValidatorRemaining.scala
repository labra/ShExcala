...
/**
 * ShACL validator using Backtracking that tracks remaining triples
 * It reflects the axiomatic semantics
 */
trait ShaclValidatorRemaining extends ShaclValidator with Logging {
...
object ShaclValidatorRemaining extends ShaclValidatorRemaining {
