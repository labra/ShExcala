...
//  lazy val sh_OpenShape = add(sh,"OpenShape")
  ...
  lazy val sh_constraint = add(sh, "constraint")
  lazy val sh_OrConstraint = add(sh, "OrConstraint")
  lazy val sh_shapes = add(sh, "shapes")
  lazy val sh_minCount = add(sh,"minCount")
  lazy val sh_maxCount = add(sh,"maxCount")
  lazy val sh_in = add(sh,"in")
...
//  lazy val sh_nodeShape = add(sh,"nodeShape")
  lazy val sh_scopeNode = add(sh,"scopeNode")
  lazy val sh_scopeClass = add(sh,"scopeClass")
